...
public class Vista extends JFrame
{
	...
	private void initialize() 
	{
		...
		btnAgregar.setBounds(93, 291, 89, 23);
		panel.add(btnAgregar);
		
		btnBorrar = new JButton("Borrar");
		btnBorrar.setBounds(457, 291, 89, 23);
		panel.add(btnBorrar);
		
		btnReporte = new JButton("Reporte");
		btnReporte.setBounds(639, 291, 89, 23);
		panel.add(btnReporte);
		
		btnActualizar = new JButton("actualizar");
		btnActualizar.setBounds(275, 291, 89, 23);
		panel.add(btnActualizar);

		btnAbmLocalidad = new JButton("ABM Localidad");
		btnAbmLocalidad.setBounds(193, 325, 122, 23);
		panel.add(btnAbmLocalidad);
		
		btnAbmTipoContacto = new JButton("ABM Tipo contacto");
		btnAbmTipoContacto.setBounds(508, 325, 122, 23);
		panel.add(btnAbmTipoContacto);
		
		btnPrueba = new JButton("PRUEBA");
		btnPrueba.setBounds(725, 325, 89, 23);
		panel.add(btnPrueba);
	}
